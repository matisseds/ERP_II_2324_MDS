		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "MasterDetail",
									"targetURL": "#masterdetailgsmasterdetailgs-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"masterdetailgsmasterdetailgs-display": {
								"semanticObject": "masterdetailgsmasterdetailgs",
								"action": "display",
								"description": "Master detail application by matisse de smet.",
								"title": "MasterDetail",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=masterdetailgs.masterdetailgs",
									"url": sap.ui.require.toUrl("masterdetailgs/masterdetailgs")
								}
							}
						}
					}
